--// VOX SPEED HUB v2.0 + KEY SYSTEM (DELTA OPTIMIZED - WITH LINK BUTTON)
...
box.Name = "MainBox"
box.Size = UDim2.new(0,320,0,240) -- Aumentado para caber o novo botão
...
keyBox.Position = UDim2.new(0.1,0,0.35,0) -- Ajustado posição
...
confirm.Position = UDim2.new(0.1,0,0.58,0) -- Ajustado posição
...
getLink.BackgroundColor3 = Color3.fromRGB(0, 120, 255) -- Cor azul para destacar
...
confirm.MouseButton1Click:Connect(function()
    if validKeys[keyBox.Text] then
        ...
        TweenService:Create(keyBox, shrinkInfo, {Size = UDim2.new(0,0,0,0)}):Play()
        TweenService:Create(confirm, shrinkInfo, {Size = UDim2.new(0,0,0,0)}):Play()
        TweenService:Create(getLink, shrinkInfo, {Size = UDim2.new(0,0,0,0)}):Play()
