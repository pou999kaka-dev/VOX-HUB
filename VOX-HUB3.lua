...
local function createHub()
	...
	main.Size = UDim2.new(0,0,0,0) -- Começa bem pequeno
	...
	-- Animação de Entrada do Hub Principal (Expandir)
...
confirm.MouseButton1Click:Connect(function()
    if validKeys[keyBox.Text] then
        ...
        -- Animação de Saída do Key System (Encolher rapidamente)
        local shrinkTween = TweenService:Create(box, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {Size = UDim2.new(0,0,0,0)})
        shrinkTween:Play()
