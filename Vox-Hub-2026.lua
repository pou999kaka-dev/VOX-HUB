...
local function createHub()
	...
	-- local insta = Instance.new("ImageButton")
	-- insta.Size = UDim2.new(0,26,0,26)
	-- insta.Position = UDim2.new(1,-70,0.5,-13)
	-- insta.BackgroundTransparency = 1
	-- insta.Image = "rbxassetid://13847004120"
	-- insta.Parent = topBar
		...
		igBtn.Position = UDim2.new(0, 10, 0.5, -15) -- Posicionado na topBar
		igBtn.BackgroundColor3 = Color3.fromRGB(0, 120, 255) -- Azul
		igBtn.Text = "ig"
		igBtn.Font = Enum.Font.GothamBold
		igBtn.TextSize = 14
		igBtn.TextColor3 = Color3.new(1, 1, 1) -- Branco
		igBtn.Parent = topBar
		
		local igCorner = Instance.new("UICorner")
		igCorner.CornerRadius = UDim.new(1, 0) -- Forma de bola
		igCorner.Parent = igBtn
		
		-- Ajustar o título para não bater no botão
		...
		igBtn.MouseButton1Click:Connect(function()
			...
			-- Mensagem de copiado com animação
			local igCopied = Instance.new("TextLabel")
			igCopied.Size = UDim2.new(0, 180, 0, 35)
			igCopied.Position = UDim2.new(0.5, -90, 0, -50) -- Aparece acima do Hub
	...
	speedBox.Text = "Super velocidade"
	...
	speedBox.Parent = main
		speedBox.Focused:Connect(function()
			speedBox.Text = "Velocidade 0-1000"
		end)

	
	local resetBtn = Instance.new("TextButton")
	resetBtn.Size = UDim2.new(0.2,0,0,34)
	resetBtn.Position = UDim2.new(0.66,0,0,80)
	...
	close.MouseButton1Click:Connect(function()
			...
			-- Animação de fechar (de baixo para cima)
	...
	topBar.InputEnded:Connect(function(i)
		...
		versionLabel.TextColor3 = Color3.fromRGB(80, 80, 80) -- Tom mais escuro
		...
		creditsLabel.TextColor3 = Color3.fromRGB(80, 80, 80) -- Tom mais escuro
